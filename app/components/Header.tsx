...
import ImageContextModal from "./ImageContextModal";
...
type Props = {
  ...
  imageContext: string;
  setImageContext: (v: string) => void;
  defaultImageContext: string;
};
  ...
  return (
    <>
      <header className="bg-blue-600 text-white px-6 py-4 shadow flex items-center justify-between">
        ...
        <div className="flex gap-2">
          ...
          <button
            ...
            className="text-sm px-4 py-2 bg-white text-purple-700 font-bold rounded-lg hover:bg-purple-50 transition"
          >
            📸 画像コンテキスト
          </button>
        </div>
      ...
      <ImageContextModal
        ...
        setContext={setImageContext}
        defaultContext={defaultImageContext}
        open={imageOpen}
